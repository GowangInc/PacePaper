...
export function renderMockGuides(mocks: readonly FullMock[] = FULL_MOCKS): string {
  ...
  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>DigitalDP — teacher mock marking guides</title>
<style>
