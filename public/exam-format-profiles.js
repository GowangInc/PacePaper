...
const AP_CALCULUS_AB = {
  ...
  papers: [formatPaper("end-of-course", "End-of-course exam — hybrid digital/paper", ["AP"], {
    ...
    instructions: "Follow the calculator rule shown for each part. Complete multiple-choice answers digitally and free-response work in the supplied practice booklet or DigitalDP working canvas.",
    guidance: "Build original questions for all four timed parts. DigitalDP locks each part when its timer ends and changes the displayed calculator rule. Supply an approved handheld graphing calculator for Parts I-B and II-A. The real Bluebook exam also offers built-in Desmos graphing during these parts; DigitalDP does not include it. The official hybrid exam uses paper free-response booklets and a candidate-controlled post-break resume, so this is adapted practice.",
    phases: [
  ...
  return [
    {
      ...
      description: "Current DigitalDP presets for IB Diploma Programme practice papers.",
      courseLabel: "Course",
      levelLabel: "Level",
      paperLabel: "Paper",
      combinedLevel: "SL/HL",
