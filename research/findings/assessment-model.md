...
- DigitalDP fixes every recording at two complete, uninterrupted student-initiated plays. It still cannot schedule the four-minute previews, lock the two-minute inter-play pause, or centrally advance three texts. Exact-cadence practice therefore still requires proctor-managed playback; the student-controlled two-play workflow is useful practice but must not be described as exact official delivery.
