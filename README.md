...
- Exam-format-first Paper Builder with provider-specific terminology and tuned starters for IB DP, IB MYP eAssessment, Cambridge IGCSE Mathematics 0580, Pearson Edexcel International GCSE Mathematics A, selected 2027 AP formats, and teacher-named school-custom practice types
...
PacePaper does not automatically mark or grade responses; teachers review and mark submitted candidate work themselves. A paper can store teacher-entered answer or marking guidance per question, which appears in authenticated teacher submission views and is excluded from candidate data. Subject teachers should moderate every paper and its marking before classroom use.
